...
public class MainActivity extends NativeActivity {
	...
	public static final String SCRIPT_SUPPORT_VERSION = "1.17.30.4";
	public static final String HALF_SUPPORT_VERSION = "1.18.0";
	private static final boolean HALF_VERSION_HAS_SCRIPTS = true;
	public static final String LITE_SUPPORT_VERSION = "1.17.32.4";
